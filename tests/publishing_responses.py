...
def response_for(prompt):
    if 'STAGE: titles' in prompt:
        return json.dumps([{'title': title, 'category': ['topic/benefit', 'curiosity/story', 'bold-perspective'][i // 5],
            ...
            for i, title in enumerate([
                ...
                'Clarity Starts With You', 'Honesty Can Be Gentle', 'You Cannot Control Every Response',
    ...
    return json.dumps({'hook': 'You can speak honestly and still make room to listen.',
        'overview': 'This episode features Lish Speaks. Explore honest communication, listening with care, and the role of prayer in finding your words.',
...
def compatible_response(prompt):
    ...
    if 'STAGE: body' in prompt:
        ...
        data['overview'] = 'This episode features ' + listing + '. Explore honest communication, listening with care, and the role of prayer in finding your words.'
